...
//go:generate go run ./internal/xsdgen/cmd/xsdgen -kind complex -schema-dir schema/musicxml-4.0 -schema musicxml.xsd -catalog catalog.xml -package musicxml -ordered-type metronome -output zz_generated_types.go
